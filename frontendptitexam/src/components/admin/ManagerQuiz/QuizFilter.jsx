...
const QuizFilter = ({ quizList, onQuizFilter }) => {
  // State for filters
  ...
  const filterQuizzes = () => {
    ...
    // Order quizzes
    if (orderBy !== null) {
      filteredQuizzes.sort((a, b) => a.title.localeCompare(b.title)); // Assuming 'name' is the property for exam name
    } else {
      filteredQuizzes.sort((a, b) => new Date(a.addDate) - new Date(b.addDate)); // Assuming 'addDate' is the property for addition date
    }
